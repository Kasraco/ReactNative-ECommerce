import { TreeHero } from "./models/TreeHero";
  ...
  return (
    <div dir="rtl">
      <div className="grid grid-rows-1 lg:grid-cols-2 gap-5">
        ...
        <div>
          <h1 className="text-5xl mt-24 font-extrabold mb-10 bg-gradient-to-r  from-orange-600 via-orange-400 p-t text-transparent bg-clip-text to-orange-200 drop-shadow-2xl">
            اپلیکیشن فروشگاهی کسری
          </h1>
